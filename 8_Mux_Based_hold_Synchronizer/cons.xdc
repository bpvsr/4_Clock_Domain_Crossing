set_property ASYNC_REG true [get_cells sel_d2_reg]
set_property ASYNC_REG true [get_cells sel_d3_reg]
...
set_input_delay -clock [get_clocks clk1] -min -add_delay 2.000 [get_ports sel]
set_input_delay -clock [get_clocks clk1] -max -add_delay 4.000 [get_ports sel]
